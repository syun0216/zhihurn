...
export default class RecommendThemeView extends Component{
  ...
  //requests
  _requestThemesData(){
    api.getTopicsById(12).then((data) => {
  ...
  //views
    ...
    render(){
        ...
        return (
            <Container>
                <CommonHeaderView statusBarSetting={_statusBarSetting} headerName="用户推荐日报" navigation={this.props.navigation}/>
