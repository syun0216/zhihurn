...
export default class MovieThemeView extends Component{
  ...
  //views
    ...
    render(){
        ...
        return (
            <Container>
                <CommonHeaderView statusBarSetting={_statusBarSetting} headerName="电影日报" navigation={this.props.navigation}/>
